...
public class SpeexTalkRecorder {
    ...
    private volatile boolean isRunning;              // 录音线程是否运行
    private volatile boolean isWorking;              // 录音线程是否工作(录音)
    private Speex speex;                    // Speex音频编解码器

    private onRecorderListener recorderListener;
    private int recordBufferSize;

    //回音消除有关 https://www.jianshu.com/p/e84a916732ab
    ...
    private void init() {
        ...
        recorderThread.setName("recorderThread");
    }
